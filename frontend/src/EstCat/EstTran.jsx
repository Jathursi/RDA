...
function EstTran({ details, setDetails }) {
    const createDetailsHandler = (detailsState, setDetailsState, defaultValues) => {
        const handleChange = (event, index) => {
            const { name, value } = event.target;
            const newData = [...detailsState];
    ...
    const tranHandler = createDetailsHandler(details, setDetails, { Transport: '', Trans_cost: '', TransQ: '' });

    return (
        <form className='mt-4'>
            <h3>Transport Details</h3>
            {details.map((tran, index) => (
                <div key={index}>
                    ...
                    <div className='row mb-3'>
                        <label className='col-sm-2 col-form-label'>Transport Cost:</label>
                        <div className='col-sm-10'>
                            <input
                                type='number'
                                className='form-control'
                    ...
                    <div className='row mb-3'>
                        <label className='col-sm-2 col-form-label'>Transport Quantity:</label>
                        <div className='col-sm-10'>
                            <input
                                type='number'
                                className='form-control'
            ...
            <div className='d-grid gap-3'>
                <button className='btn btn-secondary' type="button" onClick={tranHandler.handleAdd}>Add Transport</button>
            </div>
        </form>
    );
}
