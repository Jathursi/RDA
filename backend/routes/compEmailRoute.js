    ...
    html: `
        <div style="font-family: Arial, sans-serif; margin: 20px;">
            <div style="display: flex; align-items: center; background-color: #f5f5f5; padding: 20px; border-radius: 8px;">
                ...
                <h2 style="color: #4caf50; margin: 0;">Busy Bugs</h2>
            </div>
            <div style="text-align: center; padding: 20px;">
                <h3 style="color: #4caf50;">Hello ,</h3>
                <p style="font-size: 16px;">Improve your skills with this challenge recommended for you:</p>
                <div style="margin: 20px auto; text-align: left; padding: 15px; background-color: #ffffff; border-radius: 8px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1); max-width: 400px;">
                    <h3 style="color: #4caf50;">Java Inheritance I</h3>
                    <p>Using Inheritance one class can acquire the properties of others. This problem gives you an introduction to Java Inheritance.</p>
                </div>
            </div>
